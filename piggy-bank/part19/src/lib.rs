...
#[init(contract = "FullUserDetails", parameter = "InitParameter")]
...
#[receive(contract = "FullUserDetails", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "FullUserDetails", name = "smashAmount")]
