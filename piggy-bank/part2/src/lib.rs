...
fn piggy_smash<A: HasActions>(
    ...
    *state = PiggyBankState::Smashed;
    ...
    let dummyamount = Amount::from_micro_gtu(100);
    // Get the current balance of the smart contract. For redeployment purpose adding 100 here
    let balance = ctx.self_balance() + dummyamount;
