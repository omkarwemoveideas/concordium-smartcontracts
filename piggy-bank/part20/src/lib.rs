...
#[init(contract = "FullUserDetails2", parameter = "InitParameter")]
...
#[receive(contract = "FullUserDetails2", name = "insertAmount", payable, parameter = "u8")]
...
#[receive(contract = "FullUserDetails2", name = "smashAmount")]
